...
npm run gate              # tsc --noEmit, then the whole test suite. 2625 tests over 438 suites,
                          # about seven seconds (this tree's own 2553 plus the Cockpit's 72, which
...
acceptance/             Veridian judged by Veridian: `veridian-mvp.yaml` (the goal),
                        ...
                        rather than built
tests/                  2625 tests over 438 suites in a root `node --test` run: this tree's own
                        2553 plus the Cockpit's 72
