...
npm run gate              # tsc --noEmit, then the whole test suite. 2693 tests over 451 suites,
                          # about seven seconds (this tree's own 2601 plus the Cockpit's 92, which
...
acceptance/             Veridian judged by Veridian: `veridian-mvp.yaml` (the goal),
                        ...
                        rather than built
tests/                  2693 tests over 451 suites in a root `node --test` run: this tree's own
                        2601 plus the Cockpit's 92
