...
npm run gate              # tsc --noEmit, then the whole test suite. 2675 tests over 445 suites,
                          # about seven seconds (this tree's own 2583 plus the Cockpit's 92, which
...
acceptance/             Veridian judged by Veridian: `veridian-mvp.yaml` (the goal),
                        ...
                        rather than built
tests/                  2675 tests over 445 suites in a root `node --test` run: this tree's own
                        2583 plus the Cockpit's 92
