...
npm run gate              # tsc --noEmit, then the whole test suite. 1459 tests, about four seconds
                          # (this tree's own 1399 plus the Cockpit's 60, which the runner discovers
...
tests/                  1459 tests in a root `node --test` run: this tree's own 1399 plus the
                        Cockpit's 60
