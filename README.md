...
npm run gate              # tsc --noEmit, then the whole test suite. 2788 tests over 472 suites
                          # (this tree's own 2696 plus the Cockpit's 92, which
...
acceptance/             Veridian judged by Veridian: `veridian-mvp.yaml` (the goal),
                        ...
                        rather than built
tests/                  2788 tests over 472 suites in a root `node --test` run: this tree's own
                        2696 plus the Cockpit's 92
