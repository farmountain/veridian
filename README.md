...
npm run gate              # tsc --noEmit, then the whole test suite. 2569 tests over 426 suites,
                          # about eight seconds (this tree's own 2497 plus the Cockpit's 72, which
...
acceptance/             Veridian judged by Veridian: `veridian-mvp.yaml` (the goal),
                        ...
                        rather than built
tests/                  2569 tests over 426 suites in a root `node --test` run: this tree's own
                        2497 plus the Cockpit's 72
