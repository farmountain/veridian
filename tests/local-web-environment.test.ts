...
const plan = (overrides: Partial<EnvironmentPlan> = {}): EnvironmentPlan => ({
  ...
  url: "http://127.0.0.1:4173",  api: null,  databasePath: null,  cluster: null,  posix: null,  os: null,  cloud: null,  container: null,  vscode: null,  process: null,  health: { path: "/health", expectStatus: 200, timeoutMs: 5_000, intervalMs: 100, readyPattern: null },
