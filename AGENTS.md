...
> `npx tsc --noEmit` is silent and `node --test` reports 2675 passing tests over 445 suites -
> Veridian's own 2583 plus the 92 the VS Code Cockpit contributes, which the root runner discovers
