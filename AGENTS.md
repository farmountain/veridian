...
> `npx tsc --noEmit` is silent and `node --test` reports 2788 passing tests over 472 suites -
> Veridian's own 2696 plus the 92 the VS Code Cockpit contributes, which the root runner discovers
